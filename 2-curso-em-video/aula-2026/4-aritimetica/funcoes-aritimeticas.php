...
<body>
    ...
    $val5 = sqrt(81); /* CALCULA A RAIZ QUADRADA DO VALOR QUE ESTA DENTRO DOS PARENTES */

    // floatval() COMANDO PODER CALCULAR VALORES DECIMAIS

    // number_format($resultado, 2) PARA DIMINUIR O TAMANHO DOS VALORES DECIMAIS QUE SERÁ EXIBIDO, OU SEJA, ESSE VALOR ESTÁ RESUMIDO A APENAS DUAS CASAS
